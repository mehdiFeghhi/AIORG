...
# Import your models (ensure that Base is imported too)
...
# Provide the MetaData for Alembic
target_metadata = Base.metadata  # Make sure you're using the Base that is common across all your models
